...
class MovieTop(object):
    ...
    #             file_top.write('简短影评：' + movie[10] + '\r    \n')
    #         print('抓取结果写入文件成功...')
    ...
    def insert_into_mysql(self):
        ...
        cursor = db.cursor()
        insert_str = "insert into douban_comment(movieRank, movieName, movieForName, movieAlias," \
                     " directorName, showYear, makeCounty, movieType, movieScore, scoreNum, shortFilm) " \
